...
var doc = `{
    ...
    "paths": {
        ...
        "/v1/cms/inventory/status": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "req param #status int64 0 = SUBMITTED , 1 = APPROVE, 2 = Reject",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.InventoryStatusForm"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CheckInCheckOutForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/cms/transaction/print-ticket": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/v1/customer": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "if want to get child is_parent = false and parent_id = parameter.user_id",
                        "name": "initsearch",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ChildForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/customer/child/{id}": {
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "ID from children id",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.AddUserApps"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TransactionForm"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.AddUserApps": {
            ...
            "properties": {
                ...
                "phone_no": {
                    "description": ";Index:idx_phone,unique\"",
                    "type": "string"
                }
            }
        },
        ...
        "models.RegisterForm": {
            ...
            "properties": {
                "childs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.RegisterChild"
                    }
                },
                "confirm_pwd": {
                    "type": "string"
                ...
                "pwd": {
                    "description": "Email              string           ` + "`" + `json:\"email\" valid:\"Required;Email\"` + "`" + `",
                    "type": "string"
                }
            }
        },
        ...
        "models.TransactionForm": {
            "type": "object",
            "properties": {
                "details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TransactionDetailForm"
                    }
                },
                "outlet_id": {
                    "type": "string"
