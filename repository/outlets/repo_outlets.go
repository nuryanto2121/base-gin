...
// GetListLookUp implements ioutlets.Repository
func (r *repoOutlets) GetListLookUp(ctx context.Context, queryparam models.ParamList) (result []*models.OutletLookupList, err error) {
...
func (r *repoOutlets) CountLookUp(ctx context.Context, queryparam models.ParamList) (result int64, err error) {
	var (
		sWhere         = ""
		logger         = logging.Logger{}
		rest   (int64) = 0
