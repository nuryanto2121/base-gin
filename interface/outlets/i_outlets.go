...
type Repository interface {
	...
	GetListLookUp(ctx context.Context, queryparam models.ParamList) (result []*models.OutletLookupList, err error)
	...
	CountLookUp(ctx context.Context, queryparam models.ParamList) (result int64, err error)
	//
}
